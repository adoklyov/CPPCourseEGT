...
//
//1. Към примера от вчера добавете необходимият клас с подходящите полета и методи за създаване на Employee модел.
// Кодът от main да се организира в метод който приема име / път към файла и връща вектор от Employee обектите.
//
